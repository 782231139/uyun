...
import com.uyun.hummer.zxing.decode.InactivityTimer;
import com.uyun.hummer.zxing.decode.ScannerHandler;
import com.uyun.hummer.zxing.utils.CommonUtils;
import com.uyun.hummer.zxing.utils.DecodeUtils;
import com.uyun.hummer.zxing.utils.UriUtils;
import com.uyun.hummer.zxing.view.ScannerView;
...
public class ScannerActivity extends AppCompatActivity implements SurfaceHolder.Callback , INetworkListner {
    ...
    private com.uyun.hummer.zxing.camera.CameraManager cameraManager;
    ...
    public void onNetworkChanged(boolean available) {
        if (available) {
            if(isinit){
                Log.i("ScannerActivity", "onNetworkChanged-----quitSynchronously---" + available);
        ...
        try {
            ...
            if (handler == null) {
                ...
                if(NetWorkUtils.isNetworkConnected(this)){
                    Log.i("ScannerActivity", "onNetworkChanged-------------------");
                    handler.restartPreviewAndDecode();
                    networkError.setVisibility(View.GONE);
                }else {
                    networkError.setVisibility(View.VISIBLE);
...
//        mScannerDialogBuilder.create().show();
        ...
        //handler = new ScannerHandler(this, decodeFormats, "utf-8", cameraManager);
        Intent intent = new Intent(ScannerActivity.this, OtherWebviewActivity.class);
        intent.putExtra("title", "is_scan_result");
