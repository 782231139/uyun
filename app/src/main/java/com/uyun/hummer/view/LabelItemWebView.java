...
public class LabelItemWebView extends WebView implements INeedForOpenApi{
    private Context mContext;
    public LabelItemWebView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initWebView(context);
    }

    public LabelItemWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWebView(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LabelItemWebView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        initWebView(context);
    }

    public LabelItemWebView(Context context) {
        super(context);
        initWebView(context);
    }
