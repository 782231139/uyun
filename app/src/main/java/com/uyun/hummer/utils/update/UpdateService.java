package com.uyun.hummer.utils.update;
...
public class UpdateService extends Service {
    ...
    private static final String PACKAGE_NAME = UyunApplication.context.getPackageName();

    private static final String APP_NAME = UyunApplication.context.getResources().getText(R.string.app_name).toString();
...
//            builder.setContentIntent(getContentIntent());
    ...
    private void getContentIntent() {
        ...
        if (Build.VERSION.SDK_INT >= 24) { //判读版本是否在7.0以上
            ...
            Log.i("numread","apkFile----------------"+apkFile);
            Log.i("numread","apkUri----------------"+apkUri.toString());
